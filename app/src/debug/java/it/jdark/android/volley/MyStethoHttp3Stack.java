...
/**
 * Created by jDark on 17/04/16.
 */
public class MyStethoHttp3Stack implements HttpStack {


    public MyStethoHttp3Stack() {
    }
    ...
    public HttpResponse performRequest(com.android.volley.Request<?> request, Map<String, String> additionalHeaders)
        ...
        org.apache.http.StatusLine responseStatus = new BasicStatusLine(parseProtocol(okHttpResponse.protocol()), okHttpResponse.code(), okHttpResponse.message());
